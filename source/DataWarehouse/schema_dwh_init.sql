...
CREATE TABLE dwh.[bridge_specimen]
(
	[specimen_key] int NOT NULL
)
GO

CREATE TABLE dwh.[dim_hardware]
(
...
CREATE TABLE dwh.[dim_mushroom_type]
(
...
CREATE TABLE dwh.[dim_mushroom_stage]
(
...
ALTER TABLE dwh.[dim_mushroom_stage] 
...
ALTER TABLE dwh.[dim_hardware] ADD CONSTRAINT [FK_dim_hardware_dim_user]
	FOREIGN KEY ([user_key]) REFERENCES dwh.[dim_user] ([user_key]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE dwh.[dim_sensor_entry] ADD CONSTRAINT [FK_dim_sensor_entry_bridge_specimen]
	FOREIGN KEY ([specimen_key]) REFERENCES dwh.[bridge_specimen] ([specimen_key]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE dwh.[dim_status_entry] ADD CONSTRAINT [FK_dim_status_entry_bridge_specimen]
	FOREIGN KEY ([specimen_key]) REFERENCES dwh.[bridge_specimen] ([specimen_key]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE dwh.[dim_status_entry] ADD CONSTRAINT [FK_dim_status_entry_dim_mushroom_stage]
	FOREIGN KEY ([stage_key]) REFERENCES dwh.[dim_mushroom_stage] ([stage_key]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE dwh.[fact_specimen] ADD CONSTRAINT [FK_fact_specimen_bridge_specimen]
	FOREIGN KEY ([specimen_key]) REFERENCES dwh.[bridge_specimen] ([specimen_key]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE dwh.[fact_specimen] ADD CONSTRAINT [FK_fact_specimen_dim_hardware]
	FOREIGN KEY ([hardware_key]) REFERENCES dwh.[dim_hardware] ([hardware_key]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE dwh.[fact_specimen] ADD CONSTRAINT [FK_fact_specimen_dim_mushroom_type]
	FOREIGN KEY ([type_key]) REFERENCES dwh.[dim_mushroom_type] ([type_key]) ON DELETE No Action ON UPDATE No Action
GO
