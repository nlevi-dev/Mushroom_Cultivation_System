...
/*  Created On : 01-Apr-2021 19.38.47 				*/
...
ALTER TABLE dwh.[dim_status_entry] ADD CONSTRAINT [FK_dim_status_entry_dim_stage]
	FOREIGN KEY ([stage_key]) REFERENCES dwh.[dim_stage] ([stage_key]) ON DELETE No Action ON UPDATE No Action
GO
